pipeline {
    ...
    stages {
        ...
        stage('Prod E2E') {
            ...
            post {
                always {
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, icon: '', keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'Playright E2E Report', reportTitles: '', useWrapperFileDirectly: true])
                }
            }
        }
    }
